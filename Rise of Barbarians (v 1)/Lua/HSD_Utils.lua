-- Historical Spawn Dates Utils
-- Author: Gedemon
-- DateCreated: 1/29/2011 11:52:55 PM
--------------------------------------------------------------
include("HSD_Debug")
print("Loading Historical Spawn Dates Utils Functions...")
print("-------------------------------------")
...
function HSDAutoSave(iplayer)
	if HSD_AUTOSAVE and LOCAL_PLAYER == iplayer then
		SaveAllTable()
		Dprint("-------------------------------------")
		Dprint("Auto-Saving is ON ...")
		local saveName = "HSD_Autosave_EndTurn"
