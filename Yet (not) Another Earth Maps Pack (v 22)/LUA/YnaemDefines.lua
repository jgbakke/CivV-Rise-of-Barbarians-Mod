...
elseif ( g_dynamicCS == 1 ) then
	...
	g_MapList = { 
		...
		[HUGE_EARTH] = { ID = HUGE_EARTH, File = "Earth_Huge_blank.Civ5Map", Name = "Huge Earth", Description = "120x80 huge earth by Dale with enlarged Europe", Size = "WORLDSIZE_HUGE", Civs = 22, Minors = 41, TablePrefix = "Yahem" },
